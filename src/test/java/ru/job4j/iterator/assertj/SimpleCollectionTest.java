...
class SimpleCollectionTest {
    ...
    /**
     * Данный метод показывает основные операции
     * проверки содержания коллекции.
     */
    @Test
    void generalAssert() {
        SimpleCollection<Integer> sc = new SimpleCollection<>(1, 2, 3, 4, 5);
    ...
    /**
     * Данный тестовый метод показывает,
     * как можно проверить выполнение
     * элементами коллекции нужных условий.
     */
    @Test
    void satisfyAssert() {
    ...
    /**
     * Данный метод показывает, что можно
     * выбрать один элемент из коллекции
     * и дальше проверять только его.
     */
    @Test
    ...
    /**
     * Данный метод показывает, как можно
     * выбрать из коллекции группу элементов
     * по некоторому условию и дальше
     * работать с отобранной группой.
     */
    @Test
    ...
    /**
     * Данный тестовый метод позволяет
     * тестировать коллекцию, которая
     * реализует интерфейс {@link Map}.
     */
    @Test
    void assertMap() {
